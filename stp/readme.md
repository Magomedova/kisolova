...
---------------------------------------------------------------------------------------|------------------------
Почему этот коммутатор был выбран протоколом spanning-tree в качестве корневого моста? | В нашем случае одинаковый Bridge Priority (одинаковый vlan), поэтому выбирается тот, у   
                                                                                       | кого меньше mac-адреса.
